...
foreach ($comp in $comps) {
	...
	try {
        ...
        #>
				...
				$Services = Get-CimInstance -ClassName win32_service -Filter "state = 'stop pending'"
				if ($Services) {
        ...
        #>
				...
				Start-Process 'C:\ClientHealth\Client\ccmsetup.exe' -ArgumentList '/mp:atklsccm.kostweingroup.intern SMSSITECODE=KOW /forceinstall' -Wait
