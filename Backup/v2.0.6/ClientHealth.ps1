...
Begin {
    ...
    $Script:LogFolder = 'C:\Temp\ClientHealth'
...
Process {
    ...
    If (-NOT ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] 'Administrator')) {
        ...
        if ($null -ne $tsenv) {
            ...
            Set-RegistryValue -Path $RegistryKey -Name $ScriptVersionRegistryValueName -Value $Version
        }
    }
    ...
    try {
        ...
        $LastRunEntry = Get-RegistryValue -Path $RegistryKey -Name $LastRunRegistryValueName
        <#
        ...
        [datetime]$LastRunEntry = '01.01.1970 01:00:00'
